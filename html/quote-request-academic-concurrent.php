...
<!-- InstanceBegin template="/Templates/HOMER3.dwt" codeOutsideHTMLIsLocked="false" -->
<!--<![endif]-->
<head>
<meta charset="utf-8">
...
<title>HOMER - Hybrid Renewable Microgrid System Design Software</title>
<style type="text/css">
            ...
            <li><a href="software.html">Products</a>
              <ul>
                ...
                <li><a href="HOMER_pro.html">HOMER Pro</a>
                  <ul>
                    <li><a href="HOMER_pro.html">Information</a></li>
...
<section id="header-btm" class="clearfix">
  <div class="container">
    <div class="row">
      <div class="span12">
        <h4 class="heading-icon"> <img src="img/icons/heading-icon-1.png" width="40" height="40" alt="icon" class="icon-small-bg"> Academic Concurrent Quote Request</h4>
      </div>
    </div>
  </div>
</section>
...
<input type=hidden name="rating" value="Hot">
          <input type=hidden id="00N6100000Aw7Zm" name="00N6100000Aw7Zm" value="Academic-Concurrent">  
            <!--  ----------------------------------------------------------------------  --> 
            ...
            <br>
            <label for="company">Educational Institution</label>
            ...
            <br>
            <label>Number Of Simultaneous Users</label>
            <input  id="00N6100000AvOTs" maxlength="32" name="00N6100000AvOTs" size="20" type="number" required="true"/>
            <br>
License Length
<select  id="00N6100000AvOYT" name="00N6100000AvOYT" title="License Term">
              <option value="Annual">Annual</option>
              <option value="Permanent">Permanent</option>
              <option value="Quote Both">Please Quote Both Options</option>
            </select>
<br>
Select modules that you wish to add to the base HOMER Pro product (use shift/ctrl)
<select  id="00N6100000Aw9ME" multiple="multiple" name="00N6100000Aw9ME" title="Modules" style="height:120px;">
              <option value="Advanced Grid">Advanced Grid</option>
              <option value="Advanced Load">Advanced Load</option>
              <option value="Biomass">Biomass</option>
              <option value="Combined Heat &amp; Power">Combined Heat &amp; Power</option>
              <option value="Hydro">Hydro</option>
              <option value="Hyrdrogen">Hyrdrogen</option>
            </select>
            <br>
    ...
    <div class="row"> 
      ...
      <div class="span4">
        ...
        <ul class="list-info">
          ...
          <li><img src="http://www.homerenergy.com/img/icons/icon-18-mail.png" alt="icon"><a href="mailto:info@homerenergy.com">info@homerenergy.com</a></li>
